<template>
    <div class="row text-center">
        <!-- <div class="video-options">
            <a href="#" @click="leaveRoom" v-if="deactivateChat == false"><i class="fas fa-phone-slash"></i></a>
            <a href="#" @click="muteRoom"><i class="fas fa-volume-mute"></i></a>
            <a href="#" @click="muteRoom"><i class="fas fa-video-slash"></i></a>
...
export default {
    ...
    methods : {
        ...
        getAccessToken : function () {
            ...
            // Request a new token
            axios.get(`http://localhost:8000/token?identity=${this.username}`)
